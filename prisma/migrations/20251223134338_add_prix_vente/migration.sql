/*
  ...
  - You are about to drop the column `puht` on the `produits` table. All the data in the column will be lost.
  - Added the required column `prixVente` to the `produits` table without a default value. This is not possible if the table is not empty.
